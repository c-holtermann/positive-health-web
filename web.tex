...
\begin{tikzpicture}[scale=1]
  ...
  \path (1*\A:\L) node (L1) {\tiny Bodily functions};
  \path (2*\A:\L) node (L2) {\tiny Mental functions \& perceptions};
  \path (3*\A:\L) node (L3) {\tiny Spiritual dimension};
  \path (4*\A:\L) node (L4) {\tiny Quality of life};
  \path (5*\A:\L) node (L5) {\tiny Social \& Societal participation};
  \path (6*\A:\L) node (L6) {\tiny Daily functioning};
